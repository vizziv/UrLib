...
val elim : fields ::: {Type} -> keep ::: {Type} -> t fields keep
           -> res ::: Type
           -> (drop ::: {Type} -> [keep ~ drop]
...
val fl : fields ::: {Type} -> keep ::: {Type} -> t fields keep
         -> folder keep

val projs : fields ::: {Type} -> keep ::: {Type} -> t fields keep
            -> $fields -> $keep

val injqs : fields ::: {Type} -> keep ::: {Type} -> t fields keep
            -> $keep -> $(map option fields)
